...
function MainContent() {
  ...
  return (
    <main className="flex-1 px-14 py-10">
      ...
      <h1 className="text-[1.5rem] font-semibold mb-[0.4rem]">Users & Roles</h1>
      ...
      <div className=" relative bg-[#FFFFFF] p-4 mt-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div>
            ...
            />
            <svg
              className="absolute left-[1.8rem] mt-[-1.8rem]"
              width="16"
              height="17"
              viewBox="0 0 16 17"
              fill="none"
        ...
        <button className="px-4 py-3  bg-[#0D6EFD] flex items-center gap-2 text-white font-satoshi text-[0.9rem] font-bold rounded">
          <svg
            width="18"
            height="18"
            viewBox="0 0 18 18"
